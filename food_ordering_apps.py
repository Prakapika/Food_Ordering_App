    ...
    def user_register(self):
        try:
            while True:
                ...
                print(f"Welcome TO {self.kitchen_name} Restaurant\n")
                print("User Details : ")
...
try:
    def main():
        obj = Kitchen("The Royal Kitchen")
        print(f"*^*^*^*^*^*^*^*^*^EATZZ*^*^*^*^*^*^*^*^*^*\n")
        print(f"__/\__  Welcome To {obj.kitchen_name} Restaurant  __/\__\n")
        print("!!**********************************************************************")
